...
#define tiny_trace // requires user32.lib;Kernel32.lib
//#define tiny_wtrace // requires user32.lib;Kernel32.lib
//#define tiny_memset
#define tiny_memcpy
//#define tiny_malloc
...
#else
#define trace(...) { printf("[TinyModInjector:%d] ", __LINE__); printf(__VA_ARGS__); printf("\n"); fflush(stdout); }
#endif
#endif
